...
const WOSummaryModal = ({ isOpen, onClose }: any) => {
    ...
    return (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(15, 23, 42, 0.7)', backdropFilter: 'blur(8px)', zIndex: 1100, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '24px', width: '500px', maxWidth: '95vw', boxSizing: 'border-box', textAlign: 'center' }}>
                <h3 style={{ margin: '0 0 1rem 0' }}>สรุปใบงานรายวัน</h3>
                <p>ข้อมูล ณ วันที่เลือก (กำลังพัฒนาระบบรายละเอียดลงลึก)</p>

...
interface GroupSLACountdownProps {
  globalDeadline: number;
  subtaskDeadline: number;
  isCompleted: boolean;
}

const GroupSLACountdown: React.FC<GroupSLACountdownProps> = ({
  globalDeadline,
  subtaskDeadline,
  isCompleted,
}) => {
...
Token: ${token}`);
      ...
      {isReviewModalOpen && reviewTaskInfo && (
         <TaskReviewModal
          ...
          workOrder={reviewTaskInfo.wo as any}
          task={reviewTaskInfo.task as any}
      ...
      {isCustomerMockupOpen && mockupWorkOrder && (
         <CustomerInspectionMockup
          ...
          onSubmitInspection={async (approvals, survey) => {
            await submitCustomerInspection(
              mockupWorkOrder.id,
              approvals,
              survey,
            );

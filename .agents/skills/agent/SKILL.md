...
3. Read `d:/After_sale/.agents/platform/detected.md` → get spawn_tool, execution_type, parallel_mode
...
**Spawn call structure — varies by platform (read from `d:/After_sale/.agents/platform/detected.md`):**
...
## Environment & Paths
- Libraries: `d:/After_sale/Libraries`
- IDE Context: `d:/After_sale/IDE`
- Python install: `pip install <pkg> --target=d:/After_sale/Libraries/python`
- NPM install: `npm install <pkg> --prefix=d:/After_sale/Libraries/npm`
- Execution: `export PYTHONPATH=$PYTHONPATH:d:/After_sale/Libraries/python`

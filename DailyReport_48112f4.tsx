...
const DailyReport = () => {
    ...
    const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // 1. เธเธตเธเธญเธฑเธ”เธฃเธนเธเธ เธฒเธ (เธฅเธ”เธเธเธฒเธ”เนเธเธฅเน)
            const compressedFile = await compressImage(file, 1280, 0.7);

            // 2. เธ•เธฑเนเธเธเนเธฒ Cache Control 
            const metadata = {
    ...
    const handleLaborPhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            alert('เธญเธฑเธเนเธซเธฅเธ”เธฃเธนเธเธ เธฒเธเนเธฃเธเธเธฒเธเนเธกเนเธชเธณเน€เธฃเนเธ เธเธฃเธธเธ“เธฒเธฅเธญเธเนเธซเธกเนเธญเธตเธเธเธฃเธฑเนเธ');
        } finally {
    ...
    const handleSubmit = async () => {
        if (!selectedTaskInfo) return;
        if (photos.length === 0) return alert('เธเธฃเธธเธ“เธฒเธ–เนเธฒเธขเธฃเธนเธเธญเธฑเธเน€เธ”เธ•เธซเธเนเธฒเธเธฒเธเธญเธขเนเธฒเธเธเนเธญเธข 1 เธฃเธนเธ');
        if (laborPhotos.length === 0) return alert('เธเธฃเธธเธ“เธฒเธ–เนเธฒเธขเธฃเธนเธเธขเธทเธเธขเธฑเธเธเธเธเธฒเธเน€เธเนเธฒเธเธเธดเธเธฑเธ•เธดเธเธฒเธเธญเธขเนเธฒเธเธเนเธญเธข 1 เธฃเธนเธ');
            ...
            >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                        ...
                        {isNew && <div style={{ background: '#ef4444', color: '#fff', fontSize: '0.6rem', fontWeight: 800, padding: '2px 6px', borderRadius: '8px' }}>เนเธซเธกเน</div>}
                    </div>
            ...
            <div style={{ background: '#fff', borderRadius: '24px', border: '1px solid #e2e8f0', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                {!selectedTaskInfo ? (
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#94a3b8' }}>
                        <LayoutDashboard size={64} style={{ opacity: 0.1, marginBottom: '1.5rem' }} /><h3 style={{ margin: 0, fontWeight: 800 }}>เน€เธฅเธทเธญเธเธฃเธฒเธขเธเธฒเธฃเธเธฒเธเธ—เธตเนเธ•เนเธญเธเธเธฒเธฃเธฃเธฒเธขเธเธฒเธเธเธฅ</h3><p style={{ margin: '8px 0 0 0', fontSize: '0.9rem' }}>เธฃเธฒเธขเธเธฒเธฃเธเธฒเธเธ—เธตเนเธ—เนเธฒเธเนเธ”เนเธฃเธฑเธเธกเธญเธเธซเธกเธฒเธขเธเธฐเนเธชเธ”เธเนเธเนเธ–เธเธ”เนเธฒเธเธเนเธฒเธข</p>
                    </div>
                ) : (
                    <>
                        ...
                        <div style={{ flex: 1, overflowY: 'auto', padding: '2rem' }}>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                                        {selectedTaskInfo.task.history?.some(h => (h.date?.split('T')[0]) === reportDate) && (
                                            ...
                                            >
                                                {isEditingExisting ? (
                                                    <><CheckCircle2 size={14} /> เธเธณเธฅเธฑเธเนเธเนเนเธ...</>
                                                ) : (
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2.5rem' }}>
                                <div>
                                    ...
                                    <div style={{ padding: '1.5rem', background: '#f8fafc', borderRadius: '20px', border: '1px solid #e2e8f0' }}>
                                        ...
                                        <div style={{ marginTop: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            ...
                                            {isEditingExisting && progress > 0 && <button onClick={() => setProgress(0)} style={{ background: 'none', border: 'none', color: '#ef4444', fontSize: '0.75rem', fontWeight: 800, cursor: 'pointer' }}>เธฅเนเธฒเธเธเนเธฒ</button>}
                                        </div>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                                    ...
                                    <div>
                                        <h3 style={{ fontSize: '1.1rem', fontWeight: 900, color: '#0f172a', margin: '0 0 1.25rem 0', display: 'flex', alignItems: 'center', gap: '8px' }}><Camera size={20} color="#3b82f6" /> เธฃเธนเธเธ เธฒเธเธซเธเนเธฒเธเธฒเธ</h3>
                                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(100px, 1fr))', gap: '12px' }}>
                                            {isEditingExisting && (
                                                <label style={{ height: 100, border: '2px dashed #3b82f6', borderRadius: 16, background: '#eff6ff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#3b82f6', cursor: isUploading ? 'not-allowed' : 'pointer', opacity: isUploading ? 0.6 : 1 }}>
                                                    ...
                                                    <span style={{ fontSize: '0.7rem', fontWeight: 900, marginTop: 4 }}>{isUploading ? 'เธเธณเธฅเธฑเธเนเธซเธฅเธ”' : 'เธ–เนเธฒเธขเธฃเธนเธเธซเธเนเธฒเธเธฒเธ'}</span>
                                        ...
                                        {photos.length === 0 && <div style={{ marginTop: 8, fontSize: '0.75rem', color: '#ef4444', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '4px' }}><AlertCircle size={12} /> เธ•เนเธญเธเธกเธตเธฃเธนเธเธ เธฒเธเธญเธขเนเธฒเธเธเนเธญเธข 1 เธฃเธนเธ</div>}
                                    </div>

                                    {/* Column 2: Labor Proof Photos */}
                                    <div>
                                        <h3 style={{ fontSize: '1.1rem', fontWeight: 900, color: '#0f172a', margin: '0 0 1.25rem 0', display: 'flex', alignItems: 'center', gap: '8px' }}><Users size={20} color="#15803d" /> เธฃเธนเธเธ–เนเธฒเธขเนเธฃเธเธเธฒเธ</h3>
                                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(100px, 1fr))', gap: '12px' }}>
                                            {isEditingExisting && (
                                                <label style={{ height: 100, border: '2px dashed #15803d', borderRadius: 16, background: '#f0fdf4', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#15803d', cursor: isLaborUploading ? 'not-allowed' : 'pointer', opacity: isLaborUploading ? 0.6 : 1 }}>
                                                    ...
                                                    <span style={{ fontSize: '0.7rem', fontWeight: 900, marginTop: 4 }}>{isLaborUploading ? 'เธเธณเธฅเธฑเธเนเธซเธฅเธ”' : 'เธ–เนเธฒเธขเธฃเธนเธเธเธเธเธฒเธ'}</span>
                                        ...
                                        {laborPhotos.length === 0 && <div style={{ marginTop: 8, fontSize: '0.75rem', color: '#ef4444', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '4px' }}><AlertCircle size={12} /> เธ•เนเธญเธเธกเธตเธฃเธนเธเธขเธทเธเธขเธฑเธเธเธเธเธฒเธเธญเธขเนเธฒเธเธเนเธญเธข 1 เธฃเธนเธ</div>}
                                    </div>
                                </div>
                            </div>
